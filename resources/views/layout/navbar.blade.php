        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse justify-content-between">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a href="javascript:void(0)"
                            class="dropdown-toggle nav-link {{ request()->routeIs(['tentang-kami.visi-misi', 'tentang-kami.nilai-nilai-perusahaan']) ? 'active' : '' }}">
                            Tentang Kami
                        </a>
                        <ul class="dropdown-menu">
                            <li class="nav-item"><a href="{{ route('tentang-kami.visi-misi') }}"
                                    class="nav-link {{ request()->routeIs('tentang-kami.visi-misi') ? 'active' : '' }}">Visi
                                    & Misi</a></li>
                            <li class="nav-item"><a href="{{ route('tentang-kami.nilai-nilai-perusahaan') }}"
                                    class="nav-link {{ request()->routeIs('tentang-kami.nilai-nilai-perusahaan') ? 'active' : '' }}">Nilai-Nilai
                                    Perusahaan</a></li>
                    ...
                    <li class="nav-item">
                        <a href="javascript:void(0)"
                            class="dropdown-toggle nav-link {{ request()->routeIs(['layanan.konsultasi-it', 'layanan.integrasi-sistem', 'layanan.pengembangan-perangkat-lunak', 'layanan.keamanan-siber', 'layanan.dukungan-it']) ? 'active' : '' }}">
                            Layanan
                        </a>
                        <ul class="dropdown-menu">
                            <li class="nav-item"><a href="{{ route('layanan.konsultasi-it') }}"
                                    class="nav-link {{ request()->routeIs('layanan.konsultasi-it') ? 'active' : '' }}">Konsultasi
                                    TI</a></li>
                            <li class="nav-item"><a href="{{ route('layanan.integrasi-sistem') }}"
                                    class="nav-link {{ request()->routeIs('layanan.integrasi-sistem') ? 'active' : '' }}">Integrasi
                                    Sistem</a></li>
                            <li class="nav-item"><a href="{{ route('layanan.pengembangan-perangkat-lunak') }}"
                                    class="nav-link {{ request()->routeIs('layanan.pengembangan-perangkat-lunak') ? 'active' : '' }}">Pengembangan
                                    Perangkat Lunak</a></li>
                            <li class="nav-item"><a href="{{ route('layanan.keamanan-siber') }}"
                                    class="nav-link {{ request()->routeIs('layanan.keamanan-siber') ? 'active' : '' }}">Keamanan
                                    Siber</a></li>
                            <li class="nav-item"><a href="{{ route('layanan.dukungan-it') }}"
                                    class="nav-link {{ request()->routeIs('layanan.dukungan-it') ? 'active' : '' }}">Dukungan
                                    TI</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a href="javascript:void(0)"
                            class="dropdown-toggle nav-link {{ request()->routeIs(['solusi-bisnis.koperasi-digital', 'solusi-bisnis.rumah-sakit-digital', 'solusi-bisnis.manajemen-rantai-pemasok', 'solusi-bisnis.manajemen-gedung']) ? 'active' : '' }}">
                            Solusi Bisnis
                        </a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('karir') }}"
                            class="nav-link {{ request()->routeIs('karir') ? 'active' : '' }}">
                            Karir
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="others-option d-flex align-items-center">
                    <div class="option-item">
                        <div class="nav-btn">
                            <a href="{{ route('kontak-kami') }}" class="default-btn"
                                style="background-color:#f17a3d">Kontak Kami</a>
                        </div>
                    </div>
                    <div class="option-item">
    ...
    <div class="offcanvas-body">
        <div class="accordion" id="navbarAccordion">
            <div class="accordion-item">
                <a class="accordion-link without-icon {{ request()->routeIs('home') ? 'active' : '' }}"
                    href="{{ route('home') }}">
                    Beranda
                </a>
            </div>
            <div class="accordion-item">
                <button
                    class="accordion-button collapsed {{ request()->routeIs(['tentang-kami.visi-misi', 'tentang-kami.nilai-nilai-perusahaan']) ? 'active' : '' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#tentang-kami" aria-expanded="false"
                    aria-controls="tentang-kami">
                    Tentang Kami
                </button>
                        ...
                        <div class="accordion" id="navbarAccordion7">
                            <div class="accordion-item">
                                <a href="{{ route('tentang-kami.visi-misi') }}"
                                    class="accordion-link {{ request()->routeIs('tentang-kami.visi-misi') ? 'active' : '' }}">
                                    Visi & Misi
                                </a>
                            </div>
                            <div class="accordion-item">
                                <a href="{{ route('tentang-kami.nilai-nilai-perusahaan') }}"
                                    class="accordion-link {{ request()->routeIs('tentang-kami.nilai-nilai-perusahaan') ? 'active' : '' }}">
            ...
            <div class="accordion-item">
                <button
                    class="accordion-button collapsed {{ request()->routeIs(['layanan.konsultasi-it', 'layanan.integrasi-sistem', 'layanan.pengembangan-perangkat-lunak', 'layanan.keamanan-siber', 'layanan.dukungan-it']) ? 'active' : '' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#layanan" aria-expanded="false"
                ...
                <div id="layanan" class="accordion-collapse collapse" data-bs-parent="#navbarAccordion">
                    <div class="accordion-body">
                        <div class="accordion" id="navbarAccordion30">
                            <div class="accordion-item">
                                <a href="{{ route('layanan.konsultasi-it') }}"
                                    class="accordion-link {{ request()->routeIs('layanan.konsultasi-it') ? 'active' : '' }}">
                                    Konsultasi TI
                                </a>
                            </div>
                            <div class="accordion-item">
                                <a href="{{ route('layanan.integrasi-sistem') }}"
                                    class="accordion-link {{ request()->routeIs('layanan.integrasi-sistem') ? 'active' : '' }}">
                                    Integrasi Sistem
                                </a>
                            </div>
                            <div class="accordion-item">
                                <a href="{{ route('layanan.pengembangan-perangkat-lunak') }}"
                                    class="accordion-link {{ request()->routeIs('layanan.pengembangan-perangkat-lunak') ? 'active' : '' }}">
                                    Pengembangan Perangkat Lunak
                                </a>
                            </div>
                            <div class="accordion-item">
                                <a href="{{ route('layanan.keamanan-siber') }}"
                                    class="accordion-link {{ request()->routeIs('layanan.keamanan-siber') ? 'active' : '' }}">
                                    Keamanan Siber
                                </a>
                            </div>
                            <div class="accordion-item">
                                <a href="{{ route('layanan.dukungan-it') }}"
                                    class="accordion-link {{ request()->routeIs('layanan.dukungan-it') ? 'active' : '' }}">
                                    Dukungan TI
                                </a>
                            </div>
                        </div>
            ...
            <div class="accordion-item">
                <button
                    class="accordion-button collapsed {{ request()->routeIs(['solusi-bisnis.koperasi-digital', 'solusi-bisnis.rumah-sakit-digital', 'solusi-bisnis.manajemen-rantai-pemasok', 'solusi-bisnis.manajemen-gedung']) ? 'active' : '' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#solusi-bisnis" aria-expanded="false"
                    aria-controls="solusi-bisnis">
                    Solusi Bisnis
                </button>
                <div id="solusi-bisnis" class="accordion-collapse collapse" data-bs-parent="#navbarAccordion">
                    <div class="accordion-body">
                        <div class="accordion" id="navbarAccordion30">
                            <div class="accordion-item">
                                <a href="{{ route('solusi-bisnis.koperasi-digital') }}"
                                    class="accordion-link {{ request()->routeIs('solusi-bisnis.koperasi-digital') ? 'active' : '' }}">
                                    Koperasi Digital
                                </a>
                            </div>
                            <div class="accordion-item">
                                <a href="{{ route('solusi-bisnis.rumah-sakit-digital') }}"
                                    class="accordion-link {{ request()->routeIs('solusi-bisnis.rumah-sakit-digital') ? 'active' : '' }}">
                                    Rumah Sakit Digital
                                </a>
                            </div>
                            <div class="accordion-item">
                                <a href="{{ route('solusi-bisnis.manajemen-rantai-pemasok') }}"
                                    class="accordion-link {{ request()->routeIs('solusi-bisnis.manajemen-rantai-pemasok') ? 'active' : '' }}">
                                    Manajemen Rantai Pemasok
                                </a>
                            </div>
                            <div class="accordion-item">
                                <a href="{{ route('solusi-bisnis.manajemen-gedung') }}"
                                    class="accordion-link {{ request()->routeIs('solusi-bisnis.manajemen-gedung') ? 'active' : '' }}">
                                    Manajemen Gedung
                                </a>
                            </div>
                        </div>
            ...
            <div class="accordion-item">
                <a class="accordion-link without-icon {{ request()->routeIs('karir') ? 'active' : '' }}"
                    href="{{ route('karir') }}">
                    Karir
                </a>
            </div>
