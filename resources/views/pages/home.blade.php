                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 col-md-6 pt-25">
                                <div class="academic-item" data-aos="fade-up" data-aos-delay="100">
                                    <div class="image">
                                        <img src="template/img/all-img/academic-image-1.png" alt="image">
                                        <div class="number">
                                            <h3>01</h3>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6">
                                <div class="academic-item" data-aos="fade-up" data-aos-delay="200">
                                    <div class="image">
                                        <img src="template/img/all-img/academic-image-2.png" alt="image">
                                        <div class="number">
                                            <h3>02</h3>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6 pt-25">
                                <div class="academic-item" data-aos="fade-up" data-aos-delay="300">
                                    <div class="image">
                                        <img src="template/img/all-img/academic-image-3.png" alt="image">
                                        <div class="number">
                                            <h3>03</h3>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6">
                                <div class="academic-item" data-aos="fade-up" data-aos-delay="400">
                                    <div class="image">
                                        <img src="template/img/all-img/academic-image-4.png" alt="image">
                                        <div class="number">
                                            <h3>04</h3>
                                        </div>
                                    </div>
                ...
                <div class="news-content">
                    <ul>
                        <li class="news-item" data-aos="fade-up" data-aos-delay="100">
                            <div class="image">
                                <img src="template/img/all-img/news-image-1.png" alt="image">
                            </div>
                            <div class="content">
                                <div class="sub-title">
                        ...
                        <li class="news-item" data-aos="fade-up" data-aos-delay="200">
                            <div class="image">
                                <img src="template/img/all-img/news-image-2.png" alt="image">
                            </div>
                            <div class="content">
                                <div class="sub-title">
            ...
            <div class="col-lg-4">
                <div class="news-content-right" data-aos="fade-up" data-aos-delay="100">
                    <div class="content-box">
                        <img src="template/img/all-img/news-image-3.png" alt="iamge">
                        <div class="content">
                ...
                <div class="news-content-item" data-aos="fade-up" data-aos-delay="100">
                    <div class="content-box">
                        <div class="image">
                            <img src="template/img/all-img/news-image-4.png" alt="image">
                        </div>
                        <div class="content">
                            <div class="sub-title">
                    ...
                    <div class="content-box">
                        <div class="image">
                            <img src="template/img/all-img/news-image-5.png" alt="image">
                        </div>
                        <div class="content">
                            <div class="sub-title">
