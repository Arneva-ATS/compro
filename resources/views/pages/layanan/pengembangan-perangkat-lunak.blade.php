...
<div class="section-banner pengembangan-perangkat-lunak">
    <div class="container">
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <div class="course-widget-area">
                            <div class="image">
                                <img src="{{ asset('template/img/layanan/3.png') }}" alt="image">
                            </div>
                        </div>
                    </div>
                    {{-- <div class="col-12 mb-3">
                    ...
                    <div class="col-12 academics-section mb-3">
                        <div class="academics-left" style="margin-left:20px;">
                            <div class="ac-category">
                                <ul>
                                    <li><a class="mb-2" href="{{ route('layanan.konsultasi-it') }}">Konsultasi TI</a></li>
                                    <li><a class="mb-2" href="{{ route('layanan.integrasi-sistem') }}">Integrasi Sistem</a></li>
                                    <li><a class="mb-2 active" href="{{ route('layanan.pengembangan-perangkat-lunak') }}">Pengembangan Perangkat Lunak</a></li>
