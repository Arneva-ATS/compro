...
<div class="section-banner integrasi-sistem">
    <div class="container">
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <div class="course-widget-area">
                            <div class="image">
                                <img src="{{ asset('template/img/layanan/2.png') }}" alt="image">
                            </div>
                        </div>
                    </div>
                    {{-- <div class="col-12 mb-3">
                        ...
                        <div class="academics-left" style="margin-left:20px;">
                            <div class="ac-category">
                                <ul>
                                    ...
                                    <li><a class="mb-2 active" href="{{ route('layanan.integrasi-sistem') }}">Integrasi Sistem</a></li>
