    ...
    <div class="container">
        <div class="banner-spacing">
            <div class="section-info">
                <h2 data-aos="fade-up" data-aos-delay="100">Artikel Teknologi</h2>
                <p data-aos="fade-up" data-aos-delay="200">Arneva selalu membagikan teknologi terkini kami kepada Anda</p>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-4">
                <div class="widget-area">
                    ...
                    <div class="widget widget-catagories">
                        ...
                        {{-- <ul>
                            <li><h3><a href="#">Mobile Technology</a></h3> <span>(6)</span></li>
                            <li><h3><a href="#">Website Technology</a></h3> <span>(11)</span></li>
                            <li><h3><a href="#">Internet of Things</a></h3> <span>(9)</span></li>
                            <li><h3><a href="#">Cloud Technology</a></h3> <span>(12)</span></li>
                            <li><h3><a href="#">RESTful API</a></h3> <span>(2)</span></li>
                        </ul> --}}
